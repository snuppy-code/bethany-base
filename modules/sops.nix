{
  ...
  # puts the configuration `!include /path/to/github-pat` into nix.conf
  # when that config is being evaluated, it will pull it in from that path.
  # nya did this for higher rate limit and pulling private repos
  nix.extraOptions = ''
